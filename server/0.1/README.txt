Scratch Space and the plugins that come with it have been created by Magnie.
...
1.1 - February 23, 2012
    ...
    Added chat.py which is basically an IRC server (though it does not use the
    IRC protocol).
    
    Added auth.py which will soon give admins of the server access to built-in,
    experimental features of the plugin server.
    
    Updates on virtual_space.py

1.2 - February 27, 2012
    Replaced default plugins with chat2.
